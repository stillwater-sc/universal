...
inline sw::universal::cfloat<nbits, es, bt, hasSubnormals, hasSupernormals, isSaturating>
traceFma(sw::universal::cfloat<nbits, es, bt, hasSubnormals, hasSupernormals, isSaturating> x,
	     sw::universal::cfloat<nbits, es, bt, hasSubnormals, hasSupernormals, isSaturating> y,
	     sw::universal::cfloat<nbits, es, bt, hasSubnormals, hasSupernormals, isSaturating> z) {
	...
	cfloat<EXTENDED_PRECISION, es, bt, hasSubnormals, hasSupernormals, isSaturating> preciseX{double(x)}, preciseY{ double(y) }, preciseZ{ double(z) };
