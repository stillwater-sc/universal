// regression_test_skeleton.cpp: test suite runner for addition on areal (arbitrary real) numbers
//
...
// Configure number system environment
...
try {
	...
	std::string test_suite  = "number-system arithmetic-op verification";
