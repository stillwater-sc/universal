...
if [[ $# == 0 ]]; then
	# default is clang++14
	docker build --force-rm -t stillwater/universal:clang14.builder -f Dockerfile.clang14builder .
else
	# pick up the compiler to use, one of [gcc9 gcc10 gcc11 gcc12 clang11 clang12 clang13 clang14]
	COMPILER=$1
