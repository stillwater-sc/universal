#pragma once
// next.hpp: nextafter/nexttoward functions for triple-double (dd) floating-point
//
...
namespace sw { namespace universal {
	...
	Return Value
		...
		*/
inline td_cascade nextafter(const td_cascade& x, const td_cascade& target) {
		double hi{ x.high() };
		double lo;
		if (x < target) {
