...
constexpr dd dd_pi_3     (1.047197551196597600e+00, 1.994890429429456000e-17); // pi/3
...
constexpr dd dd_log2     (6.931471805599452862e-01, 2.319046813846299558e-17); // ln(2)
constexpr dd dd_log10    (2.302585092994045901e+00, -2.170756223382249351e-16);// ln(10)
