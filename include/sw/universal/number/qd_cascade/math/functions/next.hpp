#pragma once
// next.hpp: nextafter/nexttoward functions for quad-double (dd) floating-point
//
...
namespace sw { namespace universal {
	...
	Return Value
		...
		*/
inline qd_cascade nextafter(const qd_cascade& x, const qd_cascade& target) {
		double hi{ x.high() };
		double lo;
		if (x < target) {
