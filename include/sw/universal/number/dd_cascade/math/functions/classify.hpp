...
inline int fpclassify(const dd_cascade& a) {
...
// specialized for double-double (dd)
inline bool isfinite(const dd_cascade& a) {
...
// specialized for double-double (dd)
inline bool isnormal(const dd_cascade& a) {
...
// specialized for double-double (dd)
inline bool isdenorm(const dd_cascade& a) {
...
inline bool iszero(const dd_cascade& a) {
	return (a.high() == 0.0 && a.low() == 0.0);
}

/*
inline dd_cascade copysign(const dd& a, const dd& b)
{
