...
#endif
	// When LONG_DOUBLE_SUPPORT == 0 (e.g. MSVC where long double == double),
	// no separate long double overloads are needed — the double overloads
	// are an exact match since the types are identical.
