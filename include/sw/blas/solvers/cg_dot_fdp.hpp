#pragma once
// cg_dot_fdp.hpp: Conjugate Gradient method with dot matrix-vector operator and fused dot product compensation operators
//
...
// Algorithm scheme: dot-based matrix-vector, fused-dot-product-based compensation operators
// Input: 
//   preconditioner M
//   system matrix A
//   right hand side b
...
size_t cg_dot_fdp(const Matrix& M, const Matrix& A, const Vector& b, Vector& x, Vector& residuals, typename Matrix::value_type tolerance = typename Matrix::value_type(0.00001)) {
