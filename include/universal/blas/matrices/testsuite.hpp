...
#include <universal/blas/matrices/cage3.hpp>         //   5 x   5 Directed Weighted Graph
#include <universal/blas/matrices/Stranke94.hpp>     //  10 x  10 Undirected Weighted Graph
#include <universal/blas/matrices/Trefethen_20.hpp>  //  20 x  20 Combinatorial Problem
#include <universal/blas/matrices/pores_1.hpp>       //  30 x  30 Computational Fluid Dynamics
...
#include <universal/blas/matrices/gre_343.hpp>       // 343 x 343 Directed Weighted Graph
#include <universal/blas/matrices/bcsstk01.hpp>      //  48 x  48
...
#include <universal/blas/matrices/lund_a.hpp>        // 147 x 147 
#include <universal/blas/matrices/nos1.hpp>          // 237 x 237
#include <universal/blas/matrices/arc130.hpp>        // 130 x 130
