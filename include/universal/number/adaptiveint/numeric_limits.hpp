#pragma once
// numeric_limits.hpp: definition of numeric_limits for adaptiveint
//
...
TODO: how to make the adaptiveint class a literal type so that we can use it as a return type for min/max/lowest etc.
*/
