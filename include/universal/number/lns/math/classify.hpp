...
int fpclassify(const lns<nbits, rbits, bt>& a) {
...
// specialized for lns
template<size_t nbits, size_t rbits, typename bt>
inline bool isfinite(const lns<nbits, rbits, bt>& a) {
...
// specialized for lns
template<size_t nbits, size_t rbits, typename bt>
inline bool isinf(const lns<nbits, rbits, bt>& a) {
	return a.isinf();
}
...
// specialized for lns
template<size_t nbits, size_t rbits, typename bt>
inline bool isnan(const lns<nbits, rbits, bt>& a) {
	return a.isnan();
}
...
// specialized for lns
template<size_t nbits, size_t rbits, typename bt>
inline bool isnormal(const lns<nbits, rbits, bt>& a) {
...
// specialized for lns
template<size_t nbits, size_t rbits, typename bt>
inline bool isdenorm(const lns<nbits, rbits, bt>& a) {
