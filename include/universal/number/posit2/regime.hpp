...
// Forward definitions
template<size_t nbits, size_t es, typename bt> constexpr int calculate_k(int);
...
template<size_t nbits, size_t es, typename bt>
inline bool operator==(const regime<nbits, es, bt>& lhs, const regime<nbits, es, bt>& rhs) { return lhs._Bits == rhs._Bits && lhs._RegimeBits == rhs._RegimeBits; }
template<size_t nbits, size_t es, typename bt>
inline bool operator!=(const regime<nbits, es, bt>& lhs, const regime<nbits, es, bt>& rhs) { return !operator==(lhs, rhs); }
template<size_t nbits, size_t es, typename bt>
inline bool operator< (const regime<nbits, es, bt>& lhs, const regime<nbits, es, bt>& rhs) { return lhs._RegimeBits == rhs._RegimeBits && lhs._Bits < rhs._Bits; }
template<size_t nbits, size_t es, typename bt>
