...
void arithmetic_properties(std::ostream& ostr) {
	...
	ostr << sw::universal::quire_properties<Posit, capacity>() << std::endl;
	ostr << "Quire segments" << std::endl;
	ostr << sw::universal::quire<Posit, capacity>() << std::endl;
}
...
void ReportArithmeticProperties(size_t nbits, size_t es) {
	...
	case 8:
	{
		...
		switch (es) {
		case 0: arithmetic_properties<nbits, 0, capacity>(std::cout); break;
		case 1: arithmetic_properties<nbits, 1, capacity>(std::cout); break;
		case 2: arithmetic_properties<nbits, 2, capacity>(std::cout); break;
		case 3: arithmetic_properties<nbits, 3, capacity>(std::cout); break;
		case 4: arithmetic_properties<nbits, 4, capacity>(std::cout); break;
		case 5: arithmetic_properties<nbits, 5, capacity>(std::cout); break;
		case 6: arithmetic_properties<nbits, 6, capacity>(std::cout); break;
		case 7: arithmetic_properties<nbits, 7, capacity>(std::cout); break;
		case 8: arithmetic_properties<nbits, 8, capacity>(std::cout); break;
		case 9: arithmetic_properties<nbits, 9, capacity>(std::cout); break;
		default: std::cerr << "es = " << es << " reporting is not supported by this program\n";
		}
	}
		break;
	case 16:
...
try {
	...
	switch (capacity) {
	case 0:  ReportArithmeticProperties<0>(nbits, es); break;
	case 4:  ReportArithmeticProperties<4>(nbits, es); break;
	case 8:  ReportArithmeticProperties<8>(nbits, es); break;
	case 10: ReportArithmeticProperties<10>(nbits, es); break;
	case 16: ReportArithmeticProperties<16>(nbits, es); break;
	case 20: ReportArithmeticProperties<20>(nbits, es); break;
	case 24: ReportArithmeticProperties<24>(nbits, es); break;
	case 32: ReportArithmeticProperties<32>(nbits, es); break;
	default:
