...
try {
	...
	using Scalar = cfloat<8,3, std::uint8_t, false, false, false>;

	if (argc != 2) {
		std::cerr << "cfloat8_3 : components of a cfloat<8,3> without subnormals\n";
		std::cerr << "Show the sign/scale/fraction components of cfloat<8,3> without subnormals\n";
		std::cerr << "Usage: cfloat8_3 value\n";
		std::cerr << "Example: cfloat8_3 1.5\n";
