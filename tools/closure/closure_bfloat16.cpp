...
//
// closure_bfloat16.cpp: generate closure plots for Google Brain Float
//
...
int main() {
    ...
    std::string outputDir = "closure_plots_bfloat16";

    std::cout << "Generating closure plots for bfloat16 number system configurations...\n" << std::endl;
    ...
    std::string sampled_name = "bfloat16";
    std::string sampled_dir = "closure_plots_bfloat16";

    bool success = generateClosurePlotsPNG<bfloat16>(
        sampled_name,
        sampled_dir,
