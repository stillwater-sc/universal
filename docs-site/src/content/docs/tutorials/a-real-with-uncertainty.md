---
title: "A Real with Uncertainty"
---

# A real with uncertainty
...
| Track error accumulation         | Hidden                     | Explicit via ubit propagation  |
  ...
  The current tests compare error magnitude between areal and cfloat. The real demonstration should be: "IEEE gave a confident wrong answer; areal correctly indicated uncertainty."
