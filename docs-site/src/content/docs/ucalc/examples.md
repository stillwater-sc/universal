---
title: "ucalc Worked Examples"
description: "22 examples demonstrating ucalc capabilities across precision, cancellation, quantization, and verification"
---
...
For command reference, see the [main ucalc page](../ucalc/).
For step-by-step arithmetic visualization, see the [dedicated guide](../ucalc/step-by-step/).
For AI agent integration, see the [MCP server guide](../ucalc/mcp-server/).
