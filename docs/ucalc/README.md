...
- **AI agents** use the [MCP server](mcp-server.md) to call ucalc tools
...
| `--mcp` | Run as [MCP server](mcp-server.md) (JSON-RPC over stdio) |
...
| Command | Description |
|---------|-------------|
| `steps <expr>` | [Step-by-step arithmetic](step-by-step.md) (align, add, normalize, round) |
...
- [Worked Examples](examples.md) -- 22 examples exploring precision, cancellation, quantization, and more
- [Step-by-Step Arithmetic](step-by-step.md) -- how each number system family performs arithmetic internally
- [MCP Server](mcp-server.md) -- AI agent integration via the Model Context Protocol
