// 10b_posit.cpp: performance characterization of standard posit<10,0> configuration
//
...
// first: enable fast specialized posit<10,0>
...
try {
	...
	ReportPerformance<nbits, es>(cout, "posit<10,0>", perfReport);
