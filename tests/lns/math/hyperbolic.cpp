...
void GenerateTestCaseSinh(Ty v) {
	Ty ref;
	sw::universal::lns<nbits, es, bt> a, aref, asinh;
	a = v;
	ref = std::sinh(v);
	aref = ref;
...
void GenerateTestCaseCosh(Ty v) {
	Ty ref;
	sw::universal::lns<nbits, es, bt> a, aref, acosh;
	a = v;
	ref = std::cosh(v);
	aref = ref;
...
void GenerateTestCaseTanh(Ty v) {
	Ty ref;
	sw::universal::lns<nbits, es, bt> a, aref, atanh;
	a = v;
	ref = std::tanh(v);
	aref = ref;
...
void GenerateTestCaseAsinh(Ty v) {
	Ty ref;
	sw::universal::lns<nbits, es, bt> a, aref, aasinh;
	a = v;
	ref = std::asinh(v);
	aref = ref;
...
void GenerateTestCaseAcosh(Ty v) {
	Ty ref;
	sw::universal::lns<nbits, es, bt> a, aref, aacosh;
	a = v;
	ref = std::acosh(v);
	aref = ref;
...
void GenerateTestCaseAtanh(Ty v) {
	Ty ref;
	sw::universal::lns<nbits, es, bt> a, aref, aatanh;
	a = v;
	ref = std::atanh(v);
	aref = ref;
