...
try {
	...
	nrOfFailedTestCases += ReportTestResult(ValidateSubtraction<LNS4_1>(reportTestCases), "lns<4,1, Saturating,uint8_t>", test_tag);
	nrOfFailedTestCases += ReportTestResult(ValidateSubtraction<LNS4_2>(reportTestCases), "lns<4,2, Saturating,uint8_t>", test_tag);
	nrOfFailedTestCases += ReportTestResult(ValidateSubtraction<LNS5_2>(reportTestCases), "lns<5,2, Saturating,uint8_t>", test_tag);
	nrOfFailedTestCases += ReportTestResult(ValidateSubtraction<LNS8_3>(reportTestCases), "lns<8,3, Saturating,uint8_t>", test_tag);
	nrOfFailedTestCases += ReportTestResult(ValidateSubtraction<LNS9_4>(reportTestCases), "lns<9,4, Saturating,uint8_t>", test_tag);
	nrOfFailedTestCases += ReportTestResult(ValidateSubtraction<LNS10_4>(reportTestCases), "lns<10,4, Saturating,uint8_t>", test_tag);
