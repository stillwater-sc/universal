...
//			b = c;
	...
	*/
	void TestBlockPerformanceOnAdd() {
		...
		PerformanceRunner("blocktriple<4,uint8_t>      add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<4, uint8_t> >, NR_OPS);
		PerformanceRunner("blocktriple<8,uint8_t>      add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<8, uint8_t> >, NR_OPS);
		PerformanceRunner("blocktriple<16,uint8_t>     add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<16, uint8_t> >, NR_OPS);
		PerformanceRunner("blocktriple<32,uint8_t>     add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<32, uint8_t> >, NR_OPS);
		PerformanceRunner("blocktriple<64,uint8_t>     add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<64, uint8_t> >, NR_OPS);
		PerformanceRunner("blocktriple<128,uint8_t>    add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<128, uint8_t> >, NR_OPS / 2);
		PerformanceRunner("blocktriple<256,uint8_t>    add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<256, uint8_t> >, NR_OPS / 4);
		PerformanceRunner("blocktriple<512,uint8_t>    add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<512, uint8_t> >, NR_OPS / 8);
		PerformanceRunner("blocktriple<1024,uint8_t>   add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<1024, uint8_t> >, NR_OPS / 16);

		PerformanceRunner("blocktriple<4,uint32_t>     add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<4, uint32_t> >, NR_OPS);
		PerformanceRunner("blocktriple<8,uint32_t>     add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<8, uint32_t> >, NR_OPS);
		PerformanceRunner("blocktriple<16,uint32_t>    add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<16, uint32_t> >, NR_OPS);
		PerformanceRunner("blocktriple<32,uint32_t>    add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<32, uint32_t> >, NR_OPS);
		PerformanceRunner("blocktriple<64,uint32_t>    add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<64, uint32_t> >, NR_OPS);
		PerformanceRunner("blocktriple<128,uint32_t>   add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<128, uint32_t> >, NR_OPS / 2);
		PerformanceRunner("blocktriple<256,uint32_t>   add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<256, uint32_t> >, NR_OPS / 4);
		PerformanceRunner("blocktriple<512,uint32_t>   add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<512, uint32_t> >, NR_OPS / 8);
		PerformanceRunner("blocktriple<1024,uint32_t>  add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<1024, uint32_t> >, NR_OPS / 16);

		PerformanceRunner("blocktriple<4,uint64_t>     add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<4, uint64_t> >, NR_OPS);
		PerformanceRunner("blocktriple<8,uint64_t>     add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<8, uint64_t> >, NR_OPS);
		PerformanceRunner("blocktriple<16,uint64_t>    add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<16, uint64_t> >, NR_OPS);
		PerformanceRunner("blocktriple<32,uint64_t>    add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<32, uint64_t> >, NR_OPS);
		PerformanceRunner("blocktriple<64,uint64_t>    add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<64, uint64_t> >, NR_OPS);
		PerformanceRunner("blocktriple<128,uint64_t>   add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<128, uint64_t> >, NR_OPS / 2);
		PerformanceRunner("blocktriple<256,uint64_t>   add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<256, uint64_t> >, NR_OPS / 4);
		PerformanceRunner("blocktriple<512,uint64_t>   add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<512, uint64_t> >, NR_OPS / 8);
		PerformanceRunner("blocktriple<1024,uint64_t>  add   ", AdditionSubtractionWorkload< sw::universal::blocktriple<1024, uint64_t> >, NR_OPS / 16);
	}
