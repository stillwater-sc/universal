// amd_fp24.cpp: test suite runner for standard AMD fp24 format, which is equivalent to bfloat<24,7>
//
...
try {
	...
	const size_t ebits = 7;

	int nrOfFailedTestCases = 0;
	std::string tag = " bfloat<24,7>";

	cout << "Standard AMD fp24 format, which is equivalent to a bfloat<24,7> configuration tests" << endl;
