...
try {
	...
	GenerateBfloatTable<5, 2>(std::cout, csv);
	GenerateBfloatTable<6, 1>(std::cout, csv);
	GenerateBfloatTable<6, 2>(std::cout, csv);
	GenerateBfloatTable<6, 3>(std::cout, csv);
	*/
...
//	TestMultiply< sw::universal::bfloat<8, 2,uint8_t> > (nrOfFailedTestCases);
//	TestMultiply< sw::universal::bfloat<16, 5, uint8_t> >(nrOfFailedTestCases);
//	TestMultiply< sw::universal::bfloat<32, 8, uint8_t> >(nrOfFailedTestCases);
//	TestMultiply< sw::universal::bfloat<64, 11, uint8_t> >(nrOfFailedTestCases);
