...
try {
    ...
    */
	...
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<4, 0, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<4,0,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<4, 1, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<4,1,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<4, 2, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<4,2,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<4, 3, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<4,3,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<4, 4, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<4,4,Modulo,uint8_t>");

	nrOfFailedTestCases = ReportTestResult(ValidateConversion<8, 0, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<8,0,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<8, 1, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<8,1,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<8, 2, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<8,2,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<8, 3, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<8,3,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<8, 4, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<8,4,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<8, 5, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<8,5,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<8, 6, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<8,6,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<8, 7, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<8,7,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<8, 8, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<8,8,Modulo,uint8_t>");

	nrOfFailedTestCases = ReportTestResult(ValidateConversion<12, 0, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<12,0,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<12, 1, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<12,1,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<12, 2, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<12,2,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<12, 3, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<12,3,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<12, 4, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<12,4,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<12, 6, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<12,6,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<12, 8, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<12,8,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<12, 10, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<12,10,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<12, 12, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<12,12,Modulo,uint8_t>");

	nrOfFailedTestCases = ReportTestResult(ValidateConversion<16, 0, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<16,0,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<16, 1, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<16,1,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<16, 2, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<16,2,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<16, 3, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<16,3,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<16, 4, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<16,4,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<16, 8, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<16,8,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<16, 12, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<16,12,Modulo,uint8_t>");
	nrOfFailedTestCases = ReportTestResult(ValidateConversion<16, 16, Modulo, uint8_t>(tag, bReportIndividualTestCases), tag, "fixpnt<16,16,Modulo,uint8_t>");
