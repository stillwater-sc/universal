...
COPY --from=builder /usr/src/universal/build/numerical/numerical*                 	/usr/src/universal/build/numerical/
COPY --from=builder /usr/src/universal/build/numerical/*.cmake                		/usr/src/universal/build/numerical/
#COPY --from=builder /usr/src/universal/build/c_api/pure_c/test/posit/c_api_pure_exact_test	/usr/src/universal/build/c_api/pure_c/test/posit/c_api_pure_exact_test
...
#COPY --from=builder /usr/src/universal/build/c_api/pure_c/test/posit/c_api_pure_posit4		/usr/src/universal/build/c_api/pure_c/test/posit/c_api_pure_posit4
...
#COPY --from=builder /usr/src/universal/build/c_api/pure_c/test/posit/c_api_pure_posit16i	/usr/src/universal/build/c_api/pure_c/test/posit/c_api_pure_posit16
#COPY --from=builder /usr/src/universal/build/c_api/pure_c/test/posit/c_api_pure_posit32     	/usr/src/universal/build/c_api/pure_c/test/posit/c_api_pure_posit32
#COPY --from=builder /usr/src/universal/build/c_api/pure_c/test/posit/c_api_pure_posit64     	/usr/src/universal/build/c_api/pure_c/test/posit/c_api_pure_posit64
#COPY --from=builder /usr/src/universal/build/c_api/pure_c/test/posit/c_api_pure_posit128    	/usr/src/universal/build/c_api/pure_c/test/posit/c_api_pure_posit128
#COPY --from=builder /usr/src/universal/build/c_api/pure_c/test/posit/c_api_pure_posit256    	/usr/src/universal/build/c_api/pure_c/test/posit/c_api_pure_posit256
