// 12b_posit.cpp: performance characterization of standard posit<12,0> configuration
//
...
// first: enable fast specialized posit<12,0>
#define POSIT_FAST_POSIT_12_0 0
...
try {
	...
	ReportPerformance<nbits, es>(cout, "posit<12,0>", perfReport);
