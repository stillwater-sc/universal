...
// on {double, float} -- bfloat16's 8-bit exponent range cannot hold the deep
// expansions these series generate. The radical constants (sqrt2/3/5, phi) and
// euler_gamma stay in range and are tested on {double, float, bfloat16}.
//
