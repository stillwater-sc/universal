// api.cpp : class API tests for adaptive precision binary rational number system type
//
...
#include <iostream>
#include <string>
#include <universal/number/erational/erational.hpp>   // TODO: currently just a decimal rational
