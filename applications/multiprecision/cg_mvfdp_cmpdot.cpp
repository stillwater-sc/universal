...
size_t cg_fdp_dot(const Matrix& M, const Matrix& A, Vector& b, typename Matrix::value_type tolerance = typename Matrix::value_type(0.00001)) {
...
size_t Experiment(size_t DoF) {
	...
	return cg_fdp_dot<Matrix, Vector, MAX_ITERATIONS>(M, A, b);
...
//	using Scalar = float;
	...
	*/
	...
	size_t itr = cg_fdp_dot<Matrix, Vector, MAX_ITERATIONS>(M, A, b);
