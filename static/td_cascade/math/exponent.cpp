// exponent.cpp: test suite runner for exponentiation function for triple-double cascade (td_cascade) floats
//
...
try {
	...
	std::string test_suite  = "triple-double cascade mathlib exponentiation function validation";
	...
	for (int i = 0; i < 30; ++i) {
		...
		td_cascade exponent = exp(td_cascade(i));
		td_cascade error = exponentRef - exponent;
