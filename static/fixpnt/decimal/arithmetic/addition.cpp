// addition.cpp: test suite runner for the decimal fixed-point type
//
...
try {
	...
	std::string test_suite  = "decimal fixpnt addition tests";
	std::string test_tag    = "decimal fixpnt addition";
