// hyperbolic.cpp: test suite runner for hyperbolic functions for double-double cascade (dd_cascade) floating-point
//
...
try {
	...
	std::string test_suite  = "double-double cascade mathlib hyperbolic function validation";
	...
	{
		std::cout << "double-double cascade reference\n";
		dd_cascade x = ddc_pi_4;
		std::cout << "sinh( " << x << " ) = " << sinh(x) << '\n';
		std::cout << "cosh( " << x << " ) = " << cosh(x) << '\n';
		std::cout << "tanh( " << x << " ) = " << tanh(x) << '\n';
