// istream.cpp: dbns<8, 3> stream extraction contracts
//
// operator>>(std::istream&, dbns<8, 3>&) reads a double and assigns it. Extraction has three
...
try {
	...
	std::string test_suite  = "dbns<8, 3> stream extraction";
	std::string test_tag    = "dbns<8, 3> istream";
