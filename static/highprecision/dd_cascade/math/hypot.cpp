// hypot.cpp: test suite runner for hypot functions for double-double cascade (dd_cascade) floating-point
//
...
try {
	...
	std::string test_suite  = "dd_cascade mathlib hypothenuse function validation";
