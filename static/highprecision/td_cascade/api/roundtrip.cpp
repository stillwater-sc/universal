// roundtrip.cpp: test suite for parse/to_string round-trip validation for td_cascade
//
...
// Helper function to test round-trip conversion for td_cascade
bool TestRoundTrip(const std::string& input, const std::string& testName, bool reportTestCases) {
    ...
    // Check all 3 components for td_cascade
    constexpr size_t num_components = 3;  // td_cascade has 3 components
    ...
    for (size_t i = 0; i < num_components; ++i) {
        ...
        // This is well within triple-double precision but catches real bugs
...
try {
    ...
    std::string test_suite = "td_cascade parse/to_string round-trip validation";
