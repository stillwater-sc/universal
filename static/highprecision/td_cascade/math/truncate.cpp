// truncate.cpp: test suite runner for truncate functions for triple-double cascade (td_cascade) floating-point
//
...
try {
	...
	std::string test_suite  = "td_cascade mathlib truncate function validation";
