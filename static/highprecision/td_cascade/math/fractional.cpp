// fractional.cpp: test suite runner for fractional functions for triple-double cascade (td_cascade) floating-point
//
...
try {
	...
	std::string test_suite  = "td_cascade mathlib fractional function validation";
