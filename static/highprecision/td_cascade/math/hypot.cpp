// hypot.cpp: test suite runner for hypot functions for triple-double cascade (td_cascade) floating-point
//
...
try {
	...
	std::string test_suite  = "td_cascade mathlib hypothenuse function validation";
