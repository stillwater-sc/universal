// hypot.cpp: test suite runner for hypot functions for quad-double cascade (qd_cascade) floating-point
//
...
try {
	...
	std::string test_suite  = "qd_cascade mathlib hypothenuse function validation";
