...
namespace sw { namespace universal {
	...
	template<typename Real, std::enable_if_t<std::is_floating_point<Real>::value, bool> = true>
	void Experiment() {
		reportConversionError(reportRoundTrip<rh8, Real>(1, 5));
		reportConversionError(reportRoundTrip<rh16, Real>(1, 5));
		reportConversionError(reportRoundTrip<rh32, Real>(1, 5));
		reportConversionError(reportRoundTrip<rh64, Real>(1, 5));
	}
