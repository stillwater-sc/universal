	...
	namespace universal {
		...
		void epsilon() {
			std::cout << std::setw(5) << nbits << "\t" 
				...
				<< std::setw(15) << std::numeric_limits<rational<nbits, base8>>::epsilon() << '\n';
		}
	}
}
...
try {
	...
	std::string test_suite  = "octal rational precision characterization";
	std::string test_tag    = "octal rational precision";
