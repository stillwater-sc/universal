...
try {
	...
	nrOfFailedTestCases += ReportTestResult(ValidateNormalization< rational<2, base8, std::uint8_t> >(reportTestCases), type_tag(rational<2, base8, std::uint8_t>()), "normalization");
#endif
