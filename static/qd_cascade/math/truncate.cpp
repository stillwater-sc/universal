// truncate.cpp: test suite runner for truncate functions for quad-double cascade (qd_cascade) floating-point
//
...
try {
	...
	std::string test_suite  = "qd_cascade mathlib truncate function validation";
