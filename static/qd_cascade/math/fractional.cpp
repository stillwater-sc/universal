// fractional.cpp: test suite runner for fractional functions for quad-double cascade (qd_cascade) floating-point
//
...
try {
	...
	std::string test_suite  = "qd_cascade mathlib fractional function validation";
