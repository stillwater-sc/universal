// istream.cpp: takum<32, 5> stream extraction contracts
//
// operator>>(std::istream&, takum<32, 5>&) reads a double and assigns it. Extraction has three
...
try {
	...
	std::string test_suite  = "takum<32, 5> stream extraction";
	std::string test_tag    = "takum<32, 5> istream";
