...
// first: enable fast specialized posit<128,2>
...
try {
	...
	std::cout << "Fast specialization posit<128,2> configuration tests\n";
#else
	std::cout << "Standard posit<128,2> configuration tests\n";
#endif
