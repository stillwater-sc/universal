...
// 1. Rounding errors (e.g., 0.5 + 3 = 3.5 incorrectly rounds to 4 instead of 3)
// 2. Overflow handling (e.g., 3 + 4 = 7 gives 4 instead of inf)
// 3. The generic VerifyAddition test doesn't account for ubit semantics
