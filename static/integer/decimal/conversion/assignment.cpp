// assignment.cpp: conversion tests for decimal positional integer type
//
...
try {
	...
	std::string test_suite  = "decimal positional integer assignment/conversion";
	std::string test_tag    = "dint conversion";
	...
	// round-trip through native int
	{
		...
		int testValues[] = { 0, 1, -1, 9, -9, 99, -99, 1000, -1000, 99999999 };
	...
	{
		int start = nrOfFailedTestCases;
		long long testValues[] = { 0LL, 1LL, -1LL, 1000LL, -1000LL, 123456789LL, -123456789LL };
		for (long long v : testValues) {
			positional<16, 10> a(v);
