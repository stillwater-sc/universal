// addition.cpp: test suite runner for addition of triple-double (td) floating-point values
//
...
try {
	...
	std::string test_suite         = "triple-double addition validation";
	std::string test_tag           = "triple-double addition";
